# Voicetoto Landing Page

Landing page for voicetoto.sh - a modern Next.js 16 application.
...
5. Configure custom domain `voicetoto.sh` in Railway settings
