              ...
              <div className="flex justify-center lg:hidden my-8">
                <div className="w-full max-w-2xl">
                  <Image
                    ...
                    alt="Voicetoto Application Screenshot"
                    width={1920}
                    height={1080}
      ...
      <section className="py-12 sm:py-16 md:py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
          ...
          <div className="space-y-6 text-lg text-foreground/80 text-center">
            <p>
              Voicetoto is a <strong>local-first voice cloning studio</strong> with DAW-like
              features for professional voice synthesis. Think of it as a{' '}
            ...
            <p>
              Unlike cloud services that lock your voice data behind subscriptions, Voicetoto gives
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          ...
          <div className="flex justify-center">
            <div className="w-full max-w-5xl">
              ...
              >
                <source
                  src="/voicetoto-demo.webm"
                  type="video/webm"
                  aria-label="Voicetoto Demo Video"
                />
