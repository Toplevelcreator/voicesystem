# Contributing to Voicetoto

Thank you for your interest in contributing to Voicetoto! This document provides guidelines and instructions for contributing.
...
1. **Fork and clone the repository**
   ```bash
   git clone https://github.com/YOUR_USERNAME/voicetoto.git
   cd voicetoto
   ```
...
Thank you for contributing to Voicetoto! 🎉
