<p align="center">
  <img src=".github/assets/icon-dark.webp" alt="Voicetoto" width="120" height="120" />
</p>

<h1 align="center">Voicetoto</h1>
...
<p align="center">
  <a href="https://github.com/jamiepine/voicetoto/releases">
    <img src="https://img.shields.io/github/downloads/jamiepine/voicetoto/total?style=flat&color=blue" alt="Downloads" />
  </a>
  <a href="https://github.com/jamiepine/voicetoto/releases/latest">
    <img src="https://img.shields.io/github/v/release/jamiepine/voicetoto?style=flat" alt="Release" />
  </a>
  <a href="https://github.com/jamiepine/voicetoto/stargazers">
    <img src="https://img.shields.io/github/stars/jamiepine/voicetoto?style=flat" alt="Stars" />
  </a>
  <a href="https://github.com/jamiepine/voicetoto/blob/main/LICENSE">
    <img src="https://img.shields.io/github/license/jamiepine/voicetoto?style=flat" alt="License" />
  </a>
</p>

<p align="center">
  <a href="https://voicetoto.sh">voicetoto.sh</a> •
...
<p align="center">
  <a href="https://voicetoto.sh">
    <img src="landing/public/assets/app-screenshot-1.webp" alt="Voicetoto App Screenshot" width="800" />
  </a>
</p>

<p align="center">
  <em>Click the image above to watch the demo video on <a href="https://voicetoto.sh">voicetoto.sh</a></em>
</p>

<br/>

<p align="center">
  <img src="landing/public/assets/app-screenshot-2.webp" alt="Voicetoto Screenshot 2" width="800" />
</p>

<p align="center">
  <img src="landing/public/assets/app-screenshot-3.webp" alt="Voicetoto Screenshot 3" width="800" />
</p>
...
Voicetoto is a **local-first voice cloning studio** with DAW-like features for professional voice synthesis. Think of it as a **local, free and open-source alternative to ElevenLabs** — download models, clone voices, and generate speech entirely on your machine.

Unlike cloud services that lock your voice data behind subscriptions, Voicetoto gives you:
...
Voicetoto is available now for macOS and Windows.

| Platform | Download |
|----------|----------|
| macOS (Apple Silicon) | [Voicetoto_aarch64.app.tar.gz](https://github.com/jamiepine/voicetoto/releases/latest/download/Voicetoto_aarch64.app.tar.gz) |
| macOS (Intel) | [Voicetoto_x64.app.tar.gz](https://github.com/jamiepine/voicetoto/releases/latest/download/Voicetoto_x64.app.tar.gz) |
| Windows (MSI) | [Latest Windows MSI](https://github.com/jamiepine/voicetoto/releases/latest) |
| Windows (Setup) | [Latest Windows Setup](https://github.com/jamiepine/voicetoto/releases/latest) |
...
- **One-click server** — Turn any machine into a Voicetoto server

---

## API

Voicetoto exposes a full REST API, so you can integrate voice synthesis into your own apps.
...
Voicetoto is the beginning of something bigger. Here's what's coming:
...
- **Mobile Companion** — Control Voicetoto from your phone

Voicetoto aims to be the **one-stop shop for everything voice** — cloning, synthesis, editing, effects, and beyond.
...
```bash
# Clone the repo
git clone https://github.com/jamiepine/voicetoto.git
cd voicetoto
