...
2. Email security details to: [security@voicetoto.sh](mailto:security@voicetoto.sh)
3. Include:
...
- **Keep Voicetoto updated** - Updates include security patches
...
Voicetoto processes all audio locally by default. Your voice data never leaves your machine unless you explicitly enable remote server mode.
...
Thank you for helping keep Voicetoto secure! 🔒
