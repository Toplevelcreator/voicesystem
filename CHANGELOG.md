...
All notable changes to Voicetoto will be documented in this file.
...
- **Remote Server Mode** - Connect to a remote Voicetoto server on your network
...
[0.1.0]: https://github.com/jamiepine/voicetoto/releases/tag/v0.1.0
