...
External provider support allows you to connect Voicetoto to remotely-hosted TTS and Whisper services instead of running models locally. This is useful for:

- **Existing GPU Infrastructure**: You already have Qwen3-TTS running on a GPU server
- **AMD GPU Users**: Run models on your AMD hardware, use Voicetoto as the UI
...
Voicetoto will use OpenAI's Whisper API automatically.
...
2. Configure Voicetoto: `TTS_MODE=remote`, `TTS_REMOTE_URL=http://amd-box:8000`
3. Use Voicetoto UI for profiles, generation, editing
...
2. Each person runs Voicetoto desktop app locally
...
```
Voicetoto ──> Load Balancer ──> TTS Server 1 (GPU 1)
                           ├──> TTS Server 2 (GPU 2)
                           └──> TTS Server 3 (GPU 3)
```
...
Submit to: [GitHub Discussions](https://github.com/jamiepine/voicetoto/discussions)

## Questions?

- **Discord**: [Join the community](https://discord.gg/...)
- **GitHub**: [Open an issue](https://github.com/jamiepine/voicetoto/issues)
- **Docs**: [Full documentation](https://voicetoto.sh/docs)
